...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-1 custom-image"
        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                ...
                <div class="subheading mb-5">
                    <i class="bi bi-house"></i>{{ get_meta_value('_kota') }} -
                    {{ get_meta_value('_provinsi') }} |
                    <i class="bi bi-whatsapp"></i> <a href="https://api.whatsapp.com/send?phone={{ get_meta_value('_nohp') }}  ">+{{ get_meta_value('_nohp') }}</a> |
                    <i class="bi bi-envelope-at"></i> <a href="{{ get_meta_value('_email') }}">{{ get_meta_value('_email') }}</a>
                ...
                <div class="social-icons">
                    ...
                    <a class="social-icon" href="{{ get_meta_value('_twitter') }}"><i class="fab fa-instagram"></i></a>
